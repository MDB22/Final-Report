...
Given the aircraft presented above, the most suitable design for this project is the FireFLY6. Purchasing a FireFLY6 with the performance requirements to compete in the Challenge would cost approximately \$4100. An alternative is to purchase a hobby airframe, such as the Skywalker X8\cite{ref:x8} and design an aircraft to emulate the design of the FireFLY6.\\

The X8 is capable of up to 155km of flight\cite{ref:range}, which far exceeds the requirements for the UAV Challenge, and can easily be used to replicate the FireFLY6's motor configuration. In addition, the X8 is purpose designed to mount various sensors (such as a camera) to its frame. Appendix \ref{sec:scope} presents a detailed analysis of several design options, comparing the purchase of various FireFly6 models to several designs based on a Skywalker X8.
