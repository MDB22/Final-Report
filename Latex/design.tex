...
To achieve the novel transition system sought after from the start of the project, the optimal motor configuration was investigated for the job. Having seen the FireFLY6 aircraft, a tri-coptor formation of the motors was selected.\\
...
\todomessage{is this the first mention of LiPo? if so state full name}
