...
\todomessage{Give a breif run down on what is required by each component in order to complete the challenge}
...
The center of gravity (CoG) of the new aircraft may be changed by repositioning the batteries (the heaviest items to be carried). The CoG needed to meet two specifications:
	...
	\todomessage{Add calculation to validate if time}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=500pt]{\IMAGEPATH tuned_untuned}
	\caption{Left: Untuned roll with significant oversoot. Right: Tuned roll.\\Blue = Desired, Red = Measured}
	\label{fig:tune1}
\end{figure}
\begin{figure}[!h]
	\centering
	\includegraphics[width=500pt]{\IMAGEPATH tune_wings}
