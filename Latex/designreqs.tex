\todomessage{This section will be removed shortly, do not edit}
...
\begin{table}[!ht]
	...
	\begin{tabular}{ | l | c | c | }
		...
		\hline
		\multicolumn{3}{| c |}{\textbf{Compete in UAV Challenge 2016}} \\
		\hline
