...
\begin{enumerate}[label=\bfseries O\arabic*:] \itemsep-2pt
	...
	\item Development of a novel hybrid flight system, incorporating both Vertical Take-Off and Landing (VTOL) and Fixed-Wing flight modes, to be able to achieve requirements \textbf{R3}, \textbf{R4} and \textbf{R5}
