...
\todomessage{Might remove some of these in final}
...
\begin{enumerate}[label=\bfseries O\arabic*:] \itemsep-2pt
	...
	\todomessage{Should we make these more concrete here (low-cost = \$2000?), or just wait to the design requirements?}
